...
export const Header = ({ fan, color }) => {
  const { handleChangeColor } = useContext(DefaultContext);
...
return (
    <header style={{backgroundColor: color}}>
      ...
      <button className="btn" style={{backgroundColor: color}}  onClick={changeBackground}>
        {color==="#151515"?<StarWarsLogoSVG/>:<StarWarsDarkLogoSVG/>}
      ...
      <div className="search-layout">
        ...
        <div style={{ color: `${color==="#151515"?"white":"black"}`, paddingTop: "1rem" }}>
          I am fan of: {fan}
        </div>
      </div>
    </header>
