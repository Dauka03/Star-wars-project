...
export const Content = ({ handleCreateFan, color }) => {
  ...
  return (
    <div className="content-layout" style={{background: color}}>
      <select
        value={selector}
      ...
      {selector === "Characters" &&
        swCharacters.map((character) => (
          <ItemLists key={character.name} item={character} type="chars" colorList={color}>
